...
@section('content')
	<body class="font-[Poppins] pb-[83px]">
		...
		<nav id="Category" class="max-w-[1130px] mx-auto flex justify-center items-center gap-4 mt-[30px]">
			...
			@foreach ($categories as $item_category) {{-- kalau ada kondisi pakai forealse, kalau tidak ada kondisi pakai foreach --}}
		...
		<section id="Category-result" class="max-w-[1130px] mx-auto flex items-center flex-col gap-[30px] mt-[70px]">
			...
			<div id="search-cards" class="grid grid-cols-3 gap-[30px]">
				...
				@empty
					<p>Belum ada artikel terkait kategori tersebut.</p>
				@endforelse
			</div>
		</section>
